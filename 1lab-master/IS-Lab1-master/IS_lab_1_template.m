...
%Pagal tai, kad 3 pirmi obuoliai, o po to dvi kriauses
T=[1;1;1;-1;-1];
...
%sukuriamas masyvas klaidoms ir rezultatui gauti
e=zeros(5,1);
v=zeros(5,1);
...
% calculate the total error for these 5 inputs 
 ...
 %Paskaiciuoti paklaidas b koficiento atnaujinimui
 e2 = e(1) + e(2) + e(3) + e(4) + e(5);
n=0.1;
% write training algorithm
j=0;
while e1 ~= 0 % executes while the total error is not 0
%skaiciuoti iteraciju skaiciu
    j=j+1; 
...
%atvaizduojami parametrai xy asyje ir klasiu atskirimo linija
figure(1)
x=0:0.01:1;
f=-b/w2-x*w1/w2;
plot(x,f,'g')
...
%paduodami netestuotu paveikslu parametrai ir issprendziama ar tai obuolys
%ar kriause
